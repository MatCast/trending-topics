           ...
           <Card class="border-4 border-black bg-yellow-400 p-8 shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] rounded-none">
             <div class="flex flex-col md:flex-row items-start gap-6">
               ...
               <div class="space-y-4">
                 ...
                 <Button class="h-12 border-4 border-black bg-black text-white rounded-none shadow-[4px_4px_0px_0px_rgba(255,255,255,0.2)] uppercase font-black px-8 opacity-50 cursor-not-allowed">
                   Upgrade Required
                 </Button>
               </div>
             </div>
          ...
          <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-6">
            ...
            <div class="relative w-full sm:w-64">
              <select 
                ...
                v-model="settings.reddit_fetch_method" 
                @change="saveSettings"
              >
